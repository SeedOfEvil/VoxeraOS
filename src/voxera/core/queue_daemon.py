    ...
    def _write_state(
        ...
        *,
        ...
        record: dict[str, Any] = {
            ...
            "current_step": int(current_step if current_step is not None else existing.get("current_step", 0)),
            "completed_steps": completed_steps if completed_steps is not None else existing.get("completed_steps", []),
