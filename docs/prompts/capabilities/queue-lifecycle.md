...
- Auto-surfacing lane (current slice): only linked completions classified as `read_only_success`, `approval_blocked`, or `failed` may be proactively surfaced in chat; other classes remain manual until expanded.
