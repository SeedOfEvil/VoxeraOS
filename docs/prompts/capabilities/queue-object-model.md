...
## Session Context
- Vera tracks bounded shared session context (active draft, preview, last submitted/completed/reviewed job, last saved file, topic, ambiguity flags).
...
- Session-scoped reference resolution maps natural phrases ("that draft", "the result", "the follow-up") to concrete referents from session context. Ambiguous or missing references fail closed.
