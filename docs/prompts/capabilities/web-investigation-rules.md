...
Weather/current-condition questions have a separate Brave-backed quick-weather path and should not default to web-investigation result dumps unless the user explicitly asks to search/browse/investigate sources or the weather lookup path fails and needs fallback handling.
