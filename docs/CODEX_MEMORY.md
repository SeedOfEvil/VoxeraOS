...
- **Files changed**: `src/voxera/panel/routes_automations.py` (new), `src/voxera/panel/templates/automations.html` (new), `src/voxera/panel/templates/automation_detail.html` (new), `src/voxera/panel/app.py` (import + registration), `tests/test_panel_automations.py` (new), `docs/01_REPOSITORY_STRUCTURE_MAP.md`, `docs/02_CONFIGURATION_AND_RUNTIME_SURFACES.md`, `docs/08_TESTS_OPERATIONS_AND_CHANGE_SURFACES.md`, `docs/ops.md`, `docs/CODEX_MEMORY.md`.
