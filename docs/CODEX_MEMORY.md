...
- `app.py` reduced from ~1,490 to ~1,430 lines. The `chat()` function reduced from ~797 to ~735 lines. The inline Phase G/H response-shaping block shrank from ~127 lines to ~35 lines.
