...
- Eligibility is deterministic and conservative: only `assistant_question` requests with explicit `advisory=true`, `read_only=true`, `action_hints=["assistant.advisory"]`, and without mission/goal/steps/approval-required flags.
