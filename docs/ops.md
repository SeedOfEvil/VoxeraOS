...
Content-purity rule: canonical `write_file.content` must contain only authored body content, never draft-management/readiness narration. Wrapper replies like “I added ... to the file content” are not saveable as body text; if they quote authored body text, only the quoted body is eligible for preview content.
